...
const CustomerComplaints = () => {
    ...
    if (loading) return <div className={styles["recent-complaints-container"]}>
                <div style={{display: "flex",justifyContent: "center", alignItems: "center", height: "400px"
                }}>
                    <Oval height={70} width={70} color="#166534" wrapperStyle={{}} wrapperClass="" visible={true} ariaLabel="oval-loading" secondaryColor="#4ade80" strokeWidth={5} strokeWidthSecondary={5}/>
                </div>
            </div>
