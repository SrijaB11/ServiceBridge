            ...
            <ul className="navbar-list">
                ...
                <li className="navbar-list-items">
                    <Link to="/users" className="navbar-tabs-container">
                        <img src="/assets/Images/users.png" alt="total users" className="navbar-logo" />
                        <p className="tab-name">Users</p>
                    </Link>
                </li>
                <li className="navbar-list-items">
                    <Link to="/active-jobs" className="navbar-tabs-container">
                        <img src="/assets/Images/workers.png" alt="workers" className="navbar-logo" />
                ...
                <li className="navbar-list-items">
                    <Link to="/reviews" className="navbar-tabs-container">
                        <img src="/assets/Images/companies.png" alt="companies" className="navbar-logo" />
                        <p className="tab-name">Companies</p>
                    </Link>
                </li>
                <li className="navbar-list-items">
                    <Link to="/profile" className="navbar-tabs-container">
                        <img src="/assets/Images/payments.png" alt="payments" className="navbar-logo" />
